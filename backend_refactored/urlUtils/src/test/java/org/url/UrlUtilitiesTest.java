...
class UrlUtilitiesTest {
    ...
    void testPathVariableDetection() {        
        ...
        // Parse URLs
        List<UrlLevelEntity> result1 = processor.breakdown(url1);
        List<UrlLevelEntity> result2 = processor.breakdown(url2);
        List<UrlLevelEntity> result3 = processor.breakdown(url3);
    ...
    void testUrlDecoderOneLevel() {
        ...
        for (int i = 0; i < oneLevelUrls.size(); i++) {
            ...
            List<UrlLevelEntity> levels = processor.breakdown(url);
    ...
    void testLongUrls() {
        ...
        List<UrlLevelEntity> l1 = processor.breakdown(u1);
        assertEquals(l1, e1);
        ...
        List<UrlLevelEntity> l2 = processor.breakdown(u2);
        assertEquals(l2, e2);
    }
    ...
    void testExtendedUrlPatterns() {
        ...
        assertEquals(expected1, processor.breakdown(url1));
        ...
        assertEquals(expected2, processor.breakdown(url2));
        ...
        assertEquals(expected3, processor.breakdown(url3));
        ...
        assertEquals(expected4, processor.breakdown(url4));
        ...
        assertEquals(expected5, processor.breakdown(url5));
        ...
        assertEquals(expected6, processor.breakdown(url6));
        ...
        assertEquals(expected7, processor.breakdown(url7));
        ...
        assertEquals(expected8, processor.breakdown(url8));
        ...
        assertEquals(expected9, processor.breakdown(url9));
        ...
        assertEquals(expected10, processor.breakdown(url10));
        ...
        assertEquals(expected11, processor.breakdown(url11));
        ...
        assertEquals(expected12, processor.breakdown(url12));
        ...
        assertEquals(expected13, processor.breakdown(url13));
        ...
        assertEquals(expected14, processor.breakdown(url14));
        ...
        assertEquals(expected15, processor.breakdown(url15));
        ...
        assertEquals(expected16, processor.breakdown(url16));
        ...
        assertEquals(expected17, processor.breakdown(url17));
        ...
        assertEquals(expected18, processor.breakdown(url18));
        ...
        assertEquals(expected19, processor.breakdown(url19));
    ...
    void testEncodeMinimumLengthRequirements() {
        ...
        for (int minVarLength = 8; minVarLength <= 12; minVarLength++) {
            for (int minParamLength = 5; minParamLength <= 9; minParamLength++) {
                ...
                String encoded1 = processor.encode(url1, prefix, domainHash, encodedData, decodedData, minVarLength, minParamLength);
                ...
                String encoded2 = processor.encode(url2, prefix, domainHash, encodedData, decodedData, minVarLength, minParamLength);
                ...
                String encoded3 = processor.encode(url3, prefix, domainHash, encodedData, decodedData, minVarLength, minParamLength);
                ...
                String encoded4 = processor.encode(url4, prefix, domainHash, encodedData, decodedData, minVarLength, minParamLength);
                ...
                String encoded5 = processor.encode(url5, prefix, domainHash, encodedData, decodedData, minVarLength, minParamLength);
    ...
    void testUrlEncodingWithStructuredSegments() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (levelName.length() >= minParamLength) {
                ...
                // Encode the URL (note the new parameter)
        ...
        // Finally, test URLs with path variables and query parameters: should reuse existing encodings
        for (int i = 0; i < 3; i++) {
            String pathVariable = segments[0][0][i]; // Path variable
            String paramName = segments[0][2][i];    // Query parameter name
            String paramValue = segments[0][3][i];   // Query parameter value
    ...
    private  List<String> getTestUrls() {
        ...
        // 1. Simple URLs with just domain and path
        testUrls.add("https://example.com/users");
        testUrls.add("https://example.com/products/categories");
        testUrls.add("https://example.com/blog/posts/featured");

        // 2. URLs with path variables
        testUrls.add("https://example.com/users/123456");
        testUrls.add("https://example.com/products/electronics/laptop-x9000");
        testUrls.add("https://example.com/orders/ORD-20240415-789");

        // 3. URLs with query parameters
        testUrls.add("https://example.com/search?q=programming");
        testUrls.add("https://example.com/products?category=electronics&sort=price-asc");
        testUrls.add("https://example.com/users?status=active&role=admin&page=1");

        // 4. Complex URLs combining different elements
        testUrls.add("https://example.com/users/42/profile?tab=security&section=passwords");
        testUrls.add("https://example.com/products/electronics/smartphone-123?color=black&memory=128gb&inStock=true");
        testUrls.add("https://example.com/api/v2/data/reports/2023/Q4?format=pdf&download=true&signature=a1b2c3d4e5f6");

        // 5. URLs with long segments that will definitely be encoded
        testUrls.add("https://example.com/very-long-category-name-that-should-be-encoded");
        testUrls.add("https://example.com/products/this-is-a-very-long-product-identifier-12345");
        testUrls.add("https://example.com/search?query=this-is-a-very-long-search-query-that-should-definitely-be-encoded");

        // 6. URLs with unusual patterns
        testUrls.add("https://example.com/path-with-hyphens/underscore_segment/mixedCase123");
        testUrls.add("https://example.com/data/ranges/2020-01-01/2020-12-31");
        testUrls.add("https://example.com/special@characters?param=value&special=!@#$");
        testUrls.add("https://example.com/nested/paths/with/many/segments/that/go/deep");
        return testUrls;
    }
