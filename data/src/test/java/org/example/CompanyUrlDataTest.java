...
class CompanyUrlDataTest {
    ...
    private Company getCompany() throws IllegalAccessException, NoSuchFieldException {
        Subscription sub = SubscriptionManager.getSubscription("TIER_1");

        CompanyWrapper w = new CompanyWrapper("aaa", "www.youtube.com", sub, getTokens(), this.encoder, this.gen, 0);

        Field fc = CompanyWrapper.class.getDeclaredField("company");
        fc.setAccessible(true);
        return (Company) fc.get(w);
    ...
    @Test
    @Disabled
    void testAccessNoExistingLevel() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    void testAccessingLastLevel() throws NoSuchFieldException, IllegalAccessException {
        Company com = getCompany();
        CompanyUrlData data = new CompanyUrlData(com, "aaa");
    ...
    @Test
    void testAddingRepeatedElements() throws NoSuchFieldException, IllegalAccessException {
        Company com = getCompany();
        CompanyUrlData data = new CompanyUrlData(com, "aaa");
